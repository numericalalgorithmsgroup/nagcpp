...
namespace nagcpp {
  namespace opt {
    ...
    //     On entry, nvar = <value> must match the value
...
#define E04KFFT e04kfft_
    ...
    struct e04kf_objfun_cs {
      static void
        run(const data_handling::CallbackAddresses *callbacks,
            ...
            double &fx, const types::f77_integer inform) {
        OBJFUN objfun =
    ...
    struct e04kf_objgrd_cs {
      static void
        run(const data_handling::CallbackAddresses *callbacks,
            ...
            const types::f77_integer inform) {
        OBJGRD objgrd =
    ...
    void handle_solve_bounds_foas(COMM &comm, OBJFUN objfun, OBJGRD objgrd,
      ...
      auto local_objfun = e04kf_objfun_cs<local_objfun_x_t, OBJFUN>::run;
      ...
      using local_objgrd_fdx_t = callback_handling::get_argument_type_t<
        1, callback_handling::argument_type_of_t<OBJGRD>>;
      auto local_objgrd =
        e04kf_objgrd_cs<local_objgrd_x_t, local_objgrd_fdx_t, OBJGRD>::run;
      ...
      auto local_monit = e04kf_monit_cs<local_monit_x_t, local_monit_rinfo_t,
