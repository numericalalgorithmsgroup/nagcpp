...
namespace nagcpp {
  namespace opt {
    ...
    // opt::handle_set_nlnobj (e04rg) is a part of the NAG optimization modelling
    // suite and declares the objective function of the problem as a nonlinear
    // function with a particular gradient sparsity structure.
