...
#define E04UCFT_CONFUN                                                       \
  std::function<void(                                                        \
    ...
    const utility::array1D<types::f77_integer, data_handling::ArgIntent::IN> \
      &,                                                                     \
    const utility::array1D<double, data_handling::ArgIntent::IN> &,          \
    utility::array1D<double, data_handling::ArgIntent::OUT> &,               \
    utility::array2D<double, data_handling::ArgIntent::INOUT> &,             \
    const types::f77_integer)>
#endif
...
#define E04UCFT e04ucft_
    ...
    void
      ...
      utility::array1D<types::f77_integer, data_handling::ArgIntent::IN>
        local_needc(needc, ncnln);
      utility::array1D<double, data_handling::ArgIntent::IN> local_x(x, n);
      utility::array1D<double, data_handling::ArgIntent::OUT> local_c(c, ncnln);
      utility::array2D<double, data_handling::ArgIntent::INOUT> local_cjac(
    ...
    struct e04uc_confun_cs {
      static void run(
        ...
        utility::array1D<double, data_handling::ArgIntent::OUT> &c,
        utility::array2D<double, data_handling::ArgIntent::INOUT> &cjac,
        ...
        auto local_needc = data_handling::convert_nag_array_to_user<
          const utility::array1D<types::f77_integer,
                                 data_handling::ArgIntent::IN>,
          data_handling::ArgIntent::IN, CONFUN_NEEDC>(needc);
        ...
        auto local_c = data_handling::convert_nag_array_to_user<
          utility::array1D<double, data_handling::ArgIntent::OUT>,
          data_handling::ArgIntent::OUT, CONFUN_C>(c);
        auto local_cjac = data_handling::convert_nag_array_to_user<
          utility::array2D<double, data_handling::ArgIntent::INOUT>,
          data_handling::ArgIntent::INOUT, CONFUN_CJAC>(cjac);
    ...
    void e04uc_objfunh(const E04UCFT_OBJFUN &objfun,
      ...
      error_handler::ExceptionPointer *ep =
        static_cast<error_handler::ExceptionPointer *>(en_data.wrapptr1);
      utility::array1D<double, data_handling::ArgIntent::IN> local_x(x, n);
      utility::array1D<double, data_handling::ArgIntent::INOUT> local_objgrd(
        objgrd, n);
      data_handling::CallbackAddresses *callbacks =
        static_cast<data_handling::CallbackAddresses *>(en_data.wrapptr2);
    ...
    struct e04uc_objfun_cs {
      static void
        run(const data_handling::CallbackAddresses *callbacks,
            ...
            const utility::array1D<double, data_handling::ArgIntent::IN> &x,
            double &objf,
            utility::array1D<double, data_handling::ArgIntent::INOUT> &objgrd,
            const types::f77_integer nstate) {
        OBJFUN objfun =
        ...
        auto local_objgrd = data_handling::convert_nag_array_to_user<
          utility::array1D<double, data_handling::ArgIntent::INOUT>,
          data_handling::ArgIntent::INOUT, OBJFUN_OBJGRD>(objgrd);
    ...
    void nlp1_solve(const A &a, const BL &bl, const BU &bu, CONFUN confun,
      ...
      data_handling::RawData<types::f77_integer, data_handling::ArgIntent::OUT>
        local_iwork(static_cast<types::f77_integer>(0));
      types::f77_integer local_liwork = 0;
      data_handling::RawData<double, data_handling::ArgIntent::OUT> local_work(
