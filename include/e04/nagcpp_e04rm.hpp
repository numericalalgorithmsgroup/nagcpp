...
namespace nagcpp {
  namespace opt {
    ...
    // suite and defines the number of residuals in a sum of squares objective
    // function (nonlinear least squares problems) and, optionally, the sparsity
    // structure of their first derivatives.
